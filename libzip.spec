...
Version  : 1.9.1
Release  : 19
URL      : https://libzip.org/download/libzip-1.9.1.tar.xz
Source0  : https://libzip.org/download/libzip-1.9.1.tar.xz
...
%prep
%setup -q -n libzip-1.9.1
cd %{_builddir}/libzip-1.9.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656447462
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libzip-1.9.1/LICENSE %{buildroot}/usr/share/package-licenses/libzip/cacfcacf93466610f196733d660beace4a91f80e
pushd clr-build
%make_install
popd
