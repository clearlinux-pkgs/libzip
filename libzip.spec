...
%prep
%setup -q -n libzip-1.9.0
cd %{_builddir}/libzip-1.9.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655161141
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libzip-1.9.0/LICENSE %{buildroot}/usr/share/package-licenses/libzip/45318f6fa59e6e142cc7e81fdb34abf273b75e88
pushd clr-build
%make_install
popd
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libzip/45318f6fa59e6e142cc7e81fdb34abf273b75e88
