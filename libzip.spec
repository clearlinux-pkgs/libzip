...
Version  : 1.11.2
Release  : 25
URL      : https://libzip.org/download/libzip-1.11.2.tar.gz
Source0  : https://libzip.org/download/libzip-1.11.2.tar.gz
...
%prep
%setup -q -n libzip-1.11.2
cd %{_builddir}/libzip-1.11.2
%patch -P 1 -p1
pushd ..
cp -a libzip-1.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730767838
mkdir -p clr-build
pushd clr-build
